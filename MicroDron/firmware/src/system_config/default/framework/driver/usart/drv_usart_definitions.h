...
typedef struct
{
    ...
    /* Lines enabled for the USART operation. For a static build of the driver, 
       this is overridden by the DRV_USART_LINES_ENABLE macro in 
       the system_config.h header file. 
       For PPS parts, pin selection in ports overrides this. */
