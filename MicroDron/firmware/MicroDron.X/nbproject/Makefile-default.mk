...
${OBJECTDIR}/_ext/1161933976/roll_pid.o: ../src/drone_control/PID/roll_pid.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1161933976/roll_pid.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../../../../../microchip/harmony/v2_06/framework" -I"../../../../../../microchip/harmony/v2_06/framework" -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../src/system_config/default/framework" -MMD -MF "${OBJECTDIR}/_ext/1161933976/roll_pid.o.d" -o ${OBJECTDIR}/_ext/1161933976/roll_pid.o ../src/drone_control/PID/roll_pid.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
