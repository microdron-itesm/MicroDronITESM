        ...
        case APP_STATE_SERVICE_TASKS:{
            ...
            while(1){
                ...
                switch (readcode){
                    case 'U' :{
                        dutycycle0 = 5000;
                        DRV_OC0_Width (dutycycle0);
                        DRV_OC1_Width (dutycycle0);
                        DRV_OC2_Width (dutycycle0);
                        DRV_OC3_Width (dutycycle0);
                        readcode='\0';
                    }
                    break;
                    case 'D' :{
                    ...
                    case 'L' :{
                        ...
                        DRV_OC0_Width (dutycycle0);
                        DRV_OC1_Width (dutycycle0);
                        DRV_OC2_Width (dutycycle1);
                        DRV_OC3_Width (dutycycle1);
                        readcode='\0';
                    }
                    break;
                    case 'R' :{
                        dutycycle0 = 5000;
                        dutycycle1 = 0;
                        DRV_OC0_Width (dutycycle1);
                        DRV_OC1_Width (dutycycle1);
                        DRV_OC2_Width (dutycycle0);
                        DRV_OC3_Width (dutycycle0);
                        readcode='\0';
                    }
